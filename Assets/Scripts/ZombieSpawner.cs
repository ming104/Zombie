...
public class ZombieSpawner : MonoBehaviour {
    ...
    private void UpdateUI() {
        // 현재 웨이브와 남은 적 수 표시
        UIManager.instance.UpdateWaveText(GameManager.instance.wave, zombies.Count);
    }
    ...
    private void SpawnWave() {
        ...
        GameDataManager.Instance.UpdateGameData(1);
        
        //현재 웨이브 *1.5를 반올림한 수 만큼 좀비 생성
        int spawnCount = Mathf.RoundToInt(GameManager.instance.wave * 1.5f);
